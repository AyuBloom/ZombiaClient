const buildingInfo = {
  ...
  Door: {
    ...
    hotkey: 2,
    description:
      "These doors can be passed through by your teammates but no one else.",
    tiers: 8,
    gameModes: ["standard", "scarcity"],
  },
  SpikeTrap: {
    ...
    limitPerMember: 12,
    description:
      "These invincible tiles will spike zombies when they walk over them.",
    tiers: 8,
    gameModes: ["standard", "scarcity"],
  },
  LightningTower: {
  ...
  SawTower: {
    ...
    hotkey: 6,
    description:
      "These bad boys will cut through anything that gets too close.",
    tiers: 8,
    gameModes: ["standard", "scarcity"],
  },
  RocketTower: {
  ...
  Factory: {
    ...
    limitPerMember: 1,
    description:
      "This is what you're here to defend. Make sure it doesn't fall.",
    tiers: 8,
    gameModes: ["standard", "scarcity"],
  },
};
...
exports.getBuilding = (server, name, tier = 1) => {
  if (buildingResultCache[name]?.[tier] !== undefined)
    return buildingResultCache[name][tier];
