...
class ee extends te {
  ...
  updateDamageTint(t) {
    if (
      t.lastDamagedTick &&
      (t.lastDamagedTick !== this.lastDamagedTick ||
        !this.lastDamagedAnimationDone)
    ) {
      ((this.lastDamagedTick = t.lastDamagedTick),
        (this.lastDamagedAnimationDone = !1));
  ...
  updatePunchingWeapon(t = 300) {
    return (e, r) => {
      if (
        ...
        const r = dr.currentGame.world
            .getReplicator()
            .getMsSinceTick(e.firingTick),
          n = Math.min(r / t, 1),
          i = (Math.sin(2 * n * Math.PI) / Math.PI) * -1;
        (1 === n && (this.lastFiringAnimationDone = !0),
          this.weapon.setPositionY(20 * i));
      }
    };
  }
  ...
  updateAntiClockwiseSwingingWeapon(t = 300, e = 100) {
    return (r, n) => {
      if (
        ...
        (1 === i && (this.lastFiringAnimationDone = !0),
          this.weapon.setRotation(-o));
      }
    };
  }
...
class ne extends Jt {
  ...
  setPercent(t) {
    this.percent !== t &&
      ((this.percent = t), this.barNode.setScaleX(this.percent));
  }
  update(t, e) {
