...
export default class {
  ...
  onBuildingData(t) {
    for (let e in t) {
      ...
      if (
        ...
        this.game.ui.buildingData[r.type].built >=
          this.game.ui.buildingData[r.type].limit
      )
        this.cancelPlacing();
    }
  }
      ...
      0 == t
        ...
        : 1 == t
          ...
          : 2 == t
            ...
            : 3 == t &&
              this.borderTints[t].setPosition(r * (i / 2), r * (o - e));
  ...
  checkIsOccupied(t, e) {
    ...
    for (const t in i) {
      ...
      if (n && "HarvesterDrone" != n.model && "Projectile" !== n.entityClass)
        return true;
    }
    ...
    if (null !== this.game.ui.factory && "Harvester" !== this.buildingType) {
      ...
      if (t > this.maxFactoryDistance || e > this.maxFactoryDistance)
        return true;
    }
    return !1;
  }
  cancelPlacing() {
    if (this.buildingType) {
      ...
      if (this.buildingRangeIndicator) {
        this.game.renderer.groundLayer.removeAttachment(
          this.buildingRangeIndicator,
        );
