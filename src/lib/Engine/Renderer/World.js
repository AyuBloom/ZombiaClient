  ...
  updateEntities(t) {
    for (let e in this.entities)
      e in t
        ...
        : this.removeEntity(e);
    for (let e in t)
      !0 !== t[e] && (e in this.entities || this.createEntity(t[e]));
  }
  createEntity(t) {
  ...
  updateEntity(t, e, r = false) {
    (true === r
      ? this.entities[e].hasRunTick ||
        ((this.entities[e].hasRunTick = !0),
        this.entities[e].setTargetTick(t, r))
      : ((this.entities[e].hasRunTick = !1),
        this.entities[e].setTargetTick(t, r)),
